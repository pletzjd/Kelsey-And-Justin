...
import galleryLarge14 from '../../images/gallery-images/large/KJ048.jpg';
...
export default function Gallery() {
  return (
    <div className='gallery-content'>
      ...
      <img className='gal-image' src={gallerySmall04} alt='Standing together in an embrace in green dress and black suit on a wet wooden terrace'></img>
      <img className='gal-image' src={gallerySmall05} alt='Standing together in an embrace in green dress and black suit on a wet wooden terrace'></img>
      <img className='gal-image' src={gallerySmall06} alt='Standing together in an embrace in green dress and black suit on a wet wooden terrace'></img>
      <img className='gal-image' src={gallerySmall07} alt='Standing together in an embrace in green dress and black suit on a wet wooden terrace'></img>
      <img className='gal-image' src={gallerySmall08} alt='Standing together in an embrace in green dress and black suit on a wet wooden terrace'></img>
      <img className='gal-image' src={gallerySmall09} alt='Standing together in an embrace in green dress and black suit on a wet wooden terrace'></img>
      <img className='gal-image' src={gallerySmall10} alt='Standing together in an embrace in green dress and black suit on a wet wooden terrace'></img>
      <img className='gal-image' src={gallerySmall11} alt='Standing together in an embrace in green dress and black suit on a wet wooden terrace'></img>
      <img className='gal-image' src={gallerySmall12} alt='Standing together in an embrace in green dress and black suit on a wet wooden terrace'></img>
      <img className='gal-image' src={gallerySmall13} alt='Standing together in an embrace in green dress and black suit on a wet wooden terrace'></img>
      <img className='gal-image' src={gallerySmall14} alt='Standing together in an embrace in green dress and black suit on a wet wooden terrace'></img>
      <img className='gal-image' src={gallerySmall15} alt='Standing together in an embrace in green dress and black suit on a wet wooden terrace'></img>
