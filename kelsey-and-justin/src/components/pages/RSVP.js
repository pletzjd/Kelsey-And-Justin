...
export default function RSVP({imgData}) {
  return (
    <div className='main-content'>
      <h3 className='opener rsvp-opener fancy fancy-symbols'>Please fill out the google form linked below to RSVP. We look forward to having you with us on this magical day!</h3>
