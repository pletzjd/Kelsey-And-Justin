  ...
  return (
    <div className='main-content'>
      ...
      <div className='card'>
        ...
        <h3>Hotel</h3>
        <h1>Hotel Name</h1>
        <p className='card-description'>We've reserved a block of rooms for our guests to rent with. Use Discount code: PLACEHOLDER. Don't worry if you aren't able to snag one. There are many others in the area as well.</p>
